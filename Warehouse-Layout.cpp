...
LocationNode *WarehouseLayout::createNode(string name, string type)
{
...
void WarehouseLayout::addChild(LocationNode *parent, LocationNode *child)
{
...
void WarehouseLayout::buildDefaultLayout()
{
...
void WarehouseLayout::buildZone(LocationNode *zoneNode, string zoneLetter)
{
...
void WarehouseLayout::displayLayout(LocationNode *current, int level)
{
    if (current == NULL)
    {
        return;
...
void WarehouseLayout::showWarehouseLayout()
{
    cout << "\n========== Warehouse Layout ==========\n";
...
LocationNode *WarehouseLayout::findChild(LocationNode *parent, string childName)
{
    if (parent == NULL)
    {
        return NULL;
...
bool WarehouseLayout::searchLocation(string zoneLetter, string aisleCode, int shelfNumber)
{
...
void WarehouseLayout::generateRoute(string zoneLetter, string aisleCode, int shelfNumber)
{
...
void WarehouseLayout::traverseLayout(LocationNode *current)
{
    if (current == NULL)
    {
        return;
...
void WarehouseLayout::showTraversal()
{
    cout << "\n========== Warehouse Traversal ==========\n";
    traverseLayout(root);
}
...
// Menu for Task 5
void WarehouseLayout::task5Menu()
{
    int choice;
    string zone;
    string aisle;
